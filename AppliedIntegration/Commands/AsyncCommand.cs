...
using AppliedIntegration.Interfaces;

namespace AppliedIntegration.Commands;
...
public abstract class AsyncCommand : IAsyncCommand
{
    ...
    private static void OnRunningTasksChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
